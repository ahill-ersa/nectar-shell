...
ALLOWED_HOSTS = {{ OAGR_ALLOWED_HOSTS }}
'''
...
SITE_TITLE = "OAGR"
SITE_LONGTITLE = "Online Ancient Genome Repository"
'''
...
# Settings for the single search box with ElasticsearchSearchEngine
...
DEFAULT_INSTITUTION = "Australian Centre for Ancient DNA"
